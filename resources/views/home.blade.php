        ...
        <div class="col-md-12">
            <form role="search">
                <div class="form-group">
                    <input type="text" class="input-lg form-control" placeholder="Search post (min. 3 character)" ng-model="srcword" ng-change="filterPosts()" ng-model-options="{ debounce: 500 }">
                </div>
            </form>
        </div>
